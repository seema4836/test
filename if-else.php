...
$insert=mysqli_query($con,"insert into register(first_name,last_name,email,password,phone,gender)values('$firstName','$lastName','$email','$password','$phone','$gender')");
if($insert){
    echo "inserted";
}else{
      ...
      <div class="col">
        ...
        <div class="col">
            ...
            <input type="checkbox" id="defaultRegisterFormLastName" class="form-control" placeholder="" name="skills" value="PHP">PHP
               <input type="checkbox" id="defaultRegisterFormLastName" class="form-control" placeholder="" value="female" name="skills">Java
